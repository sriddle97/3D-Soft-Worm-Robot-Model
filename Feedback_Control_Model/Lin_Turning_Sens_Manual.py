## Open-Loop Controller for Manually Scaled Peristaltic Turning 
#
# Author: Shane Riddle
#
...
# realistic servo motor limitations. This code runs an open-loop 
# control algorithm which scales turning response based on manually
# defined activation difference. Turns are performed by altering 
# activation level of one side, timing remains the same.
...
## manual_bias variable sets the turning intensity (0-1), smaller value means sharper turn
...
# vid_names = ["Time_sens_0.5r_manual0.9_f0.3.mp4", "Time_sens_0.6r_manual0.9_f0.3.mp4", "Time_sens_0.7r_manual0.9_f0.3.mp4", "Time_sens_0.8r_manual0.9_f0.3.mp4", "Time_sens_0.9r_manual0.9_f0.3.mp4", "Time_sens_1.0r_manual0.9_f0.3.mp4", "Time_sens_1.1r_manual0.9_f0.3.mp4", "Time_sens_1.2r_manual0.9_f0.3.mp4", "Time_sens_1.3r_manual0.9_f0.3.mp4"]
# plot_names = ["Time_sens_0.5r_manual0.9_f0.3.png", "Time_sens_0.6r_manual0.9_f0.3.png", "Time_sens_0.7r_manual0.9_f0.3.png", "Time_sens_0.8r_manual0.9_f0.3.png", "Time_sens_0.9r_manual0.9_f0.3.png", "Time_sens_1.0r_manual0.9_f0.3.png", "Time_sens_1.1r_manual0.9_f0.3.png", "Time_sens_1.2r_manual0.9_f0.3.png", "Time_sens_1.3r_manual0.9_f0.3.png"]
# data_filenames = ['Time_sens_0.5r_manual0.9_f0.3.csv', 'Time_sens_0.6r_manual0.9_f0.3.csv', 'Time_sens_0.7r_manual0.9_f0.3.csv', 'Time_sens_0.8r_manual0.9_f0.3.csv', 'Time_sens_0.9r_manual0.9_f0.3.csv', 'Time_sens_1.0r_manual0.9_f0.3.csv', 'Time_sens_1.1r_manual0.9_f0.3.csv', 'Time_sens_1.2r_manual0.9_f0.3.csv', 'Time_sens_1.3r_manual0.9_f0.3.csv']
# defined_friction = ['0.3', '0.3', '0.3', '0.3', '0.3', '0.3', '0.3', '0.3', '0.3']
# manual_bias = 0.9

# file_paths = [r'\pipes\90_pipe_0.6_wide.xml']
# vid_names = ["Time_sens_0.6r_manual0.9_f0.3.mp4"]
# plot_names = ["Time_sens_0.6r_manual0.9_f0.3.png"]
# data_filenames = ['Time_sens_0.6r_manual0.9_f0.3.csv']
# defined_friction = ['0.3']

# file_paths = [r'\pipes\90_pipe_1.3_wide.xml']
# vid_names = ["Time_sens_1.3r_norm_f0.3_wideview.mp4"]
# plot_names = ["Time_sens_1.3r_norm_f0.3_wideview.png"]
# data_filenames = ['Time_sens_1.3r_norm_f0.3_wideview.csv']
# defined_friction = ['0.3']
# manual_bias = 1.0

# file_paths = [r'\pipes\90_pipe_1.3_wide.xml']
# vid_names = ["Time_sens_1.3r_manual0.3_f0.3_wideview.mp4"]
# plot_names = ["Time_sens_1.3r_manual0.3_f0.3_wideview.png"]
# data_filenames = ['Time_sens_1.3r_manual0.3_f0.3_wideview.csv']
# defined_friction = ['0.3']
# manual_bias = 0.3

file_paths = [r'\pipes\90_pipe_0.6_wide.xml']
vid_names = ["Time_sens_manual_test.mp4"]
plot_names = ["Time_sens_manual_test.png"]
data_filenames = ['Time_sens_manual_test.csv']
defined_friction = ['0.3']
manual_bias = 0.5
...
tmax = 36000           # simulation runtime (ms)
...
for path in file_paths:
    ...
    for i in tqdm(range(numSteps), miniters=500):
        ...
        # print(feedback)
        if feedback[i] > 2 or feedback[i] < -2:       # trigger the manual turn with contact
            cont_timer = 6000           # (ms)

        ## Set control signal using the commanded manual turning intensity (rate limited)
        if feedback[i] >= 1 and cont_timer > 0:                                     # Turn to the left
            l_feed_sig[i] = np.min([rate_limit(l_old_feed_sig, manual_bias, sig_rate_lim_step), l_min_sig])
            ...
            r_feed_sig[i] = np.min([rate_limit(r_old_feed_sig, manual_bias, sig_rate_lim_step), r_min_sig])
        ...
        for j in range(Nseg):
            if i != numSteps-1:
                ...
                ## Can use if statements to turn turning on and off if running back to back iterations with straight-line and turns
                # if count == 0 or count == 2:
                #     Act_sig_l[i,j] = Act_sig[i,j]+(rest_act-Act_sig[i,j])*(1-l_bias[j])
                #     data_mj.ctrl[2*j] = Act_sig_l[i,j]               # Left
                #     Act_sig_r[i,j] = Act_sig[i,j]+(rest_act-Act_sig[i,j])*(1-r_bias[j])
                #     data_mj.ctrl[2*j+1] = Act_sig_r[i,j]             # Right
                # if count == 1 or count == 3:                                      # This ignores turning
