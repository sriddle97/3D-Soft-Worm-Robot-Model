function make_bodies(helix_vecs,xml_skeleton_path,final_xml_path)
    ...
    for i = 1:length(RH_helixes)
        ...
        xml_file.mujoco.worldbody.body{1,i}.composite.geom.Attributes.size = '0.00299';
        xml_file.mujoco.worldbody.body{1,i+length(RH_helixes)}.composite.geom.Attributes.density = '571.6';
        ...
        xml_file.mujoco.worldbody.body{1,i+length(RH_helixes)}.composite.geom.Attributes.size = '0.00299';
        xml_file.mujoco.worldbody.body{1,i+length(RH_helixes)}.composite.geom.Attributes.density = '571.6';
